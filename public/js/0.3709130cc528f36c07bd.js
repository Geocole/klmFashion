...
"use strict";
__webpack_require__.r(__webpack_exports__);
!(function webpackMissingModule() { var e = new Error("Cannot find module 'get-json'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());


var getCountry = function getCountry() {
  return new Promise(function (resolve, reject) {
    !(function webpackMissingModule() { var e = new Error("Cannot find module 'get-json'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('https://ipinfo.io/json', function (error, response) {
      if (error) {
        reject(error);
      }
