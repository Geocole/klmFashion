...
@section('layout-content')
    <section class="section">
        ...
        <div class="section-body">
            ...
            Veuillez utiliser le tableau ci-dessous pour naviguer ou filtrer les résultats. Vous pouvez télécharger le tableau comme excel et pdf.
            </p>
            <div class="card">
                <div class="box">
                    <div class="box-header">
                        <h2 class="blue text-primary"><i class="fa-fw fas fa-users"></i>Clients</h2>
                        <div class="box-icon">
                            <ul class="btn-tasks">
                                <li class="dropdown">
                                    <a data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false" href="#">
                                        <i class="icon fas fa-tasks tip" data-placement="left" title="" data-original-title="Actions"></i>
                                    </a>
                                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                                        ...
                                        <li class="dropdown-item">
                                            <a href="https://sma.tecdiary.com/admin/customers/import_csv" data-toggle="modal" data-target="#myModal">
                                                <i class="fas fa-plus-circle"></i> Ajouter des clients par CSV </a>
                                        </li>
                                        <li class="dropdown-item">
                                            <a href="#" id="excel" data-action="export_excel">
                                                <i class="fas fa-file-excel-o"></i> Exporter vers le fichier Excel </a>
                                        </li>
                                        <li class="divider"></li>
                                        <li class="dropdown-item">
                                            <a href="#" class="bpo" title="<b>Supprimer les clients</b>" data-content="<p>Êtes-vous sûr?</p><button type='button' class='btn btn-danger' id='delete' data-action='delete'>Oui, je suis sûr</a> <button class='btn bpo-close'>Non</button>" data-html="true" data-placement="left">
                                                <i class="fas fa-trash-o"></i> Supprimer les clients </a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <div class="box-content">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <p class="introtext">Veuillez utiliser le tableau ci-dessous pour naviguer ou filtrer les résultats. Vous pouvez télécharger le tableau comme excel et pdf.</p>
